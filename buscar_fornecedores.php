...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id_fornecedor"])) {
    ...
    $stmt->execute(['id_fornecedor' => $_GET["id_fornecedor"]]);
    ...
    if ($rows) {
        ...
        echo json_encode(["error" => "Nenhum pedido encontrado com o nome do cliente especificado"]);
    }
} else {
