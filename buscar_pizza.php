...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["sabor_pizza"])) {
    ...
    $stmt = $conn->prepare('SELECT * FROM pedidos WHERE sabor_pizza = :sabor_pizza');

    // Executa a consulta com o pizza da pizza fornecido
    $stmt->execute(['sabor_pizza' => $_GET["sabor_pizza"]]);
